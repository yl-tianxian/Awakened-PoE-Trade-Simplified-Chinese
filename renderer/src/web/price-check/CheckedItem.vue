<template>
  <div v-if="show" class="p-4 layout-column min-h-0">
    ...
    <div v-if="true" class="mt-auto border border-dashed p-2">
      ...
      <div class="mb-1"><a href="https://afdian.com/a/apt_zh_cn" class="inline-flex align-middle animate__animated animate__fadeInRight" target="_blank">{{ t('Support development CN on') }} <img class="inline h-5" src="/images/aifadain.png"></a></div>
